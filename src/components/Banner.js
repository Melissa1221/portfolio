...
export const Banner = () => {
    ...
    const determinePointQuantity = distance => Math.min(
                ...
                <Row className = "aling-items-center">
                    <Col xs = {12} md = {7} xl = {7}  >
                        ...
                        <div className="d-flex gap-3">
                            <a href='https://www.linkedin.com/in/melissa-iman-noriega-118a95228/' target='_blank' rel='noreferrer'>
                                <button>{t("banner.contact")}<ArrowRightCircle size={25} className='logo-button'/></button>
                            </a>
